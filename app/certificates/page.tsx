...
export default function CertificatesPage() {
  ...
  const masters = [
    { id: "Mai Linh ", name: "Lan Hương" },
    { id: "Nguyệt Nga", name: "Mai Vy" },
  ];
  ...
  const predefinedAmounts =
    getCurrentLanguage() === "vi" || getCurrentLanguage() === "en"
      ? ["1000", "1500", "2000", "3000"]
      : ["50", "75", "100", "150"];

  const currency =
    getCurrentLanguage() === "vi" || getCurrentLanguage() === "en" ? "đ" : "đ";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (emailResult.success) {
        ...
        alert(
          "Đã xảy ra lỗi khi gửi đơn hàng. Vui lòng liên hệ với chúng tôi qua điện thoại."
        );
      }
    } catch (error) {
